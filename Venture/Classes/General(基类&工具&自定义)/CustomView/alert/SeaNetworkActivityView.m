...
- (void)layoutSubviews
{
    ...
    CGSize size = [self.msgLabel.text stringSizeWithFont:self.msgLabel.font contraintWith:SCREEN_WIDTH];
    ...
    {
        frame.origin.y = (SCREEN_HEIGHT - frame.size.height) / 2.0;
    }
    else
    {
        frame.origin.y = (self.superview.height - frame.size.height) / 2.0 - STATUES_HEIGHT - NAV_BAR_HEIGHT;
    }
