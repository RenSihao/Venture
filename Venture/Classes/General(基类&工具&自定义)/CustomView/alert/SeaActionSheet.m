...
- (id)init
{
    self = [super initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - SeaActionSheetMargin * 2, 0)];
    if(self)
    {
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self)
    {
        ...
        _line = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, _separatorLineWidth_)];
...
- (void)initlization
{
    ...
    //tableView高度
    CGFloat tableViewHeight = MIN(_otherButtonTitles.count * SeaActionSheetButtonHeight + titleHeight, SCREEN_HEIGHT - STATUES_HEIGHT - NAV_BAR_HEIGHT - SeaActionSheetMargin * 3 - SeaActionSheetButtonHeight);
