...
{
    return [self.searchBar valueForKey:@"searchField"];
}
...
{
    return [self.searchBar valueForKey:@"cancelButton"];
}
...
- (void)loadView
{
    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.contentHeight)];
...
{
    _searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 45.0)];
    ...
    if(self.showBackgroundWhileSearchingAndEmptyInput)
    {
        if(!_transparentView)
        {
            switch (_searchBarPosition)
            {
                ...
                case SeaSearchBarPositionTableViewHeader :
                {
                    _transparentView = [[UIView alloc] initWithFrame:CGRectMake(0, self.searchBar.bottom, SCREEN_WIDTH, self.contentHeight)];
                }
                    break;
                case SeaSearchBarPositionNavigationBar :
                {
                    _transparentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.contentHeight)];
                }
                    break;
                case SeaSearchBarPositionShowWhenSearch :
                {
                    _transparentView = [[UIView alloc] initWithFrame:CGRectMake(0, self.searchBar.height + self.statusBarHidden, SCREEN_WIDTH, self.contentHeight)];
                }
                    break;
                default:
                    break;
