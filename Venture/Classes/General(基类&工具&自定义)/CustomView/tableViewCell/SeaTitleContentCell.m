...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self)
    {
        ...
        //内容
        _contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(_titleLabel.right + _SeaTitleContentCellControlInterval_, y, SCREEN_WIDTH - _SeaTitleContentCellMargin_ * 2 - _SeaTitleContentCellArrowWidth_ - _SeaTitleContentCellControlInterval_ * 2 - _SeaTitleContentCellTitleWidth_, font.lineHeight)];
        ...
        _arrowImageView = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - _SeaTitleContentCellMargin_ - _SeaTitleContentCellArrowWidth_, 0, _SeaTitleContentCellArrowWidth_, image.size.height)];
...
- (void)layoutSubviews
{
    ...
    CGFloat width = SCREEN_WIDTH - _SeaTitleContentCellMargin_ * 2 - _SeaTitleContentCellArrowWidth_ - _SeaTitleContentCellControlInterval_ * 2 - _titleWidth;
